...
public class WomanDetailActivity extends AppCompatActivity {
    private int womanId;
    ...
    @Override protected void onCreate(Bundle b) {
        ...
        btnAddHealth.setOnClickListener(v -> startActivity(new Intent(this, HealthCheckActivity.class).putExtra("woman_id", womanId)));
